...
################################################################
# This is a generated script based on design: zcu104_hep
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_broadcaster_mm2s, and set properties
  set axis_broadcaster_mm2s [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 axis_broadcaster_mm2s ]

  # Create instance: axis_broadcaster_s2mm, and set properties
  set axis_broadcaster_s2mm [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_broadcaster:1.1 axis_broadcaster_s2mm ]
  ...
  set hpa_module [ create_bd_cell -type ip -vlnv xilinx.com:ip:hpa_module:1.0 hpa_module ]
  ...
  # Create instance: proc_sys_reset_pl_clk0, and set properties
  set proc_sys_reset_pl_clk0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_pl_clk0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins axis_broadcaster_mm2s/S_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_s2mm1_M01_AXIS [get_bd_intf_pins axis_broadcaster_mm2s/M01_AXIS] [get_bd_intf_pins hpa_module/s_img_axis]
  ...
  connect_bd_net -net Net [get_bd_pins clk_wiz/clk_in1] [get_bd_pins proc_sys_reset_pl_clk0/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/pl_clk0]
  connect_bd_net -net axi_dma_mm2s_introut [get_bd_pins axi_dma/mm2s_introut] [get_bd_pins xlconcat/In0]
  connect_bd_net -net axi_dma_s2mm_introut [get_bd_pins axi_dma/s2mm_introut] [get_bd_pins xlconcat/In1]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_MM2S] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM] -force
